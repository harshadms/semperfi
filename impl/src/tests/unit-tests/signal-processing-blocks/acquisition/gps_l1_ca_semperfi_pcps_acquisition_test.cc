 ...
 * GpsL1CaSemperFiPcpsAcquisition class based on some input parameters.
...
class GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx;

#if GNURADIO_USES_STD_POINTERS
using GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_sptr = std::shared_ptr<GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx>;
#else
using GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_sptr = boost::shared_ptr<GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx>;
#endif

GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_sptr GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_make();

class GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx : public gr::block
{
private:
    friend GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_sptr GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_make();
    void msg_handler_events(const pmt::pmt_t &msg);
    GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx();

public:
    int rx_message;
    ~GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx() override;  //!< Default destructor
};


GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_sptr GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_make()
{
    return GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_sptr(new GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx());
}


void GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx::msg_handler_events(const pmt::pmt_t &msg)
{
    try
        {
...
GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx::GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx() : gr::block("GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0))
{
    ...
    this->set_msg_handler(pmt::mp("events"),
        ...
        boost::bind(&GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx::msg_handler_events, this, boost::placeholders::_1));
#else
        boost::bind(&GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx::msg_handler_events, this, _1));
#endif
#endif
    rx_message = 0;
}
...
GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx::~GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx() = default;


// ###########################################################

class GpsL1CaSemperFiPcpsAcquisitionTest : public ::testing::Test
{
protected:
    GpsL1CaSemperFiPcpsAcquisitionTest()
    {
    ...
    ~GpsL1CaSemperFiPcpsAcquisitionTest() override = default;
...
void GpsL1CaSemperFiPcpsAcquisitionTest::init()
{
    ...
    config->set_property("Acquisition_1C.implementation", "GPS_L1_CA_SemperFi_PCPS_Acquisition");
...
void GpsL1CaSemperFiPcpsAcquisitionTest::plot_grid()
{
...
TEST_F(GpsL1CaSemperFiPcpsAcquisitionTest /*unused*/, Instantiate /*unused*/)
{
    std::shared_ptr<GpsL1CaSemperFiPcpsAcquisition> acquisition = std::make_shared<GpsL1CaSemperFiPcpsAcquisition>(config.get(), "Acquisition_1C", 1, 0);
}


TEST_F(GpsL1CaSemperFiPcpsAcquisitionTest /*unused*/, ConnectAndRun /*unused*/)
{
    int fs_in = 4000000;
    int nsamples = 4000;
...
#if GNURADIO_USES_STD_POINTERS
    std::shared_ptr<GpsL1CaSemperFiPcpsAcquisition> acquisition = std::make_shared<GpsL1CaSemperFiPcpsAcquisition>(config.get(), "Acquisition_1C", 1, 0);
    std::shared_ptr<GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx> msg_rx = GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_make();
#else
    boost::shared_ptr<GpsL1CaSemperFiPcpsAcquisition> acquisition = boost::make_shared<GpsL1CaSemperFiPcpsAcquisition>(config.get(), "Acquisition_1C", 1, 0);
    boost::shared_ptr<GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx> msg_rx = GpsL1CaSemperFiPcpsAcquisitionTest_msg_rx_make();
#endif
...
TEST_F(GpsL1CaSemperFiPcpsAcquisitionTest /*unused*/, ValidationOfResults /*unused*/)
{
    std::chrono::time_point<std::chrono::system_clock> start;
    std::chrono::time_point<std::chrono::system_clock> end;
