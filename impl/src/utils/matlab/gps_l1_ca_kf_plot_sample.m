...
samplingFreq = 25e6;     %[Hz]
channels = 4;
first_channel = 0;
code_period = 0.001;

path    = '/media/remote_filesystem/paprika/home/data/trk/';  %% CHANGE THIS PATH
figpath = [path];

for N=1:1:channels
    tracking_log_path = [path 'epl_tracking_c' num2str(N+first_channel-1) '.dat']; %% CHANGE epl_tracking_ch_ BY YOUR dump_filename
